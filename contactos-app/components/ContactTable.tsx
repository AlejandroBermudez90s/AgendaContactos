...
const COLS: { key: keyof Contact; label: string; truncate?: boolean }[] = [
  { key: "Nombre", label: "Nombre", truncate: true },
  { key: "Ámbito", label: "Ámbito" },
  { key: "Cargo", label: "Cargo / Institución", truncate: true },
  { key: "Correo", label: "Correo", truncate: true },
  { key: "Teléfono", label: "Teléfono" },
  { key: "Medio", label: "Medio" },
  { key: "Respuesta", label: "Respuesta" },
  { key: "Positiva", label: "Acciones" },
];
